...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--latent_dim_t", type=int, help="dimension of the latent space", default=4)
    ...
    parser.add_argument("--factor", type=int, default=0, help="Choose a factor to encode")
